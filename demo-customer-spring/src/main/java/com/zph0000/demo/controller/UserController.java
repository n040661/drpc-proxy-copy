package com.zph0000.demo.controller;

import com.zph0000.demo.dto.UserDto;
import com.zph0000.demo.service.UserService;
...
public class UserController {
    ...
    public void addUser(@RequestParam(required = true)String name,@RequestParam(required = true)Integer age){
