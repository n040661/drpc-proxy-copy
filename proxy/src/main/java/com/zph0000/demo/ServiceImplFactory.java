package com.zph0000.demo;

import com.zph0000.demo.bolt.BoltHandle;
import com.zph0000.demo.bolt.ConfigBoltHandle;
import com.zph0000.demo.config.ExtendProperties;
import com.zph0000.demo.proxy.ServiceProxyFactory;
import com.zph0000.demo.rpc.RpcHandle;
import com.zph0000.demo.rpc.drpc.StormLocalDrpcHandle;
import com.zph0000.demo.rpc.drpc.StormRemoteDrpcHandle;
...
public class ServiceImplFactory {
    ...
    public static void init(){
        try {
            ...
            String drpcBoltHandle = pps.getProperty("drpc.bolt.handle","com.zph0000.demo.bolt.ConfigBoltHandle");
